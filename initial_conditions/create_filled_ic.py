...
def driver(args):
  ...
  ncei_thredds_url = 'https://www.ncei.noaa.gov/thredds-ocean/dodsC/woa23/DATA'
  ...
  #https://www.ncei.noaa.gov/thredds-ocean/dodsC/woa23/DATA/salinity/netcdf/decav91C0/0.25/woa23_decav91C0_s00_04.nc

  # Get the data from NODC
  # Get monthly temperature & salinity
  base_url_t=ncei_thredds_url + '/temperature/netcdf/' + decade + '/' + res + '/'
  file_root_t='woa23_' + decade + '_t'
  ...
  base_url_s=ncei_thredds_url + '/salinity/netcdf/' + decade + '/' + res + '/'
  file_root_s='woa23_' + decade + '_s'
