...
# MOM6 supergrid:
nc_sgrd = netCDF4.Dataset('../supergrid/ORCA_gridgen/ocean_hgrid_trimmed.nc')
...
# Topography and mask
nc_topo = netCDF4.Dataset('../topography/topo_tx1_4v1_SRTM15_V2.4_S0.5.nc')
